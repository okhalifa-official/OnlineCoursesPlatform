  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        <p className="text-brandRed text-xs font-bold uppercase tracking-widest mb-3">Regional Leadership</p>
              ...
              {members.map((m, i) => (
                <tr key={m.name} className={`border-t border-gray-100 hover:bg-softGrey transition ${i % 2 === 0 ? "bg-white" : "bg-gray-50/40"}`}>
                  ...
                  <td className="px-5 py-4 hidden sm:table-cell">
                    <span className="inline-block bg-brandRed/8 text-brandRed text-xs font-semibold px-2.5 py-1 rounded-lg">{m.specialty}</span>
                  </td>
                </tr>
              ))}
            </tbody>
